...
class Specialite
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Certificat::class, mappedBy="specialite")
     */
    private $certificats;
    ...
    public function removeCertificat(Certificat $certificat): self
    {
        if ($this->certificats->removeElement($certificat)) {
            ...
            if ($certificat->getSpecialite() === $this) {
                $certificat->setSpecialite(null);
            }
        }
